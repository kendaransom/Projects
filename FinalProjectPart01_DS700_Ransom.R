# Data Cleanse for DS700 Final Project
...
# sort "cleaned" data by year then month
#abbeville.df = abbeville.df[order(abbeville.df$Year, abbeville.df$Month), ]
#head(abbeville.df)
...
# Write to .csv file
write.csv2(hc.data, "Abbeville_Cleansed.csv")

# Forecasting for DS 700 Final Project
# Forecasting Code for Abbeville Heart Condition Data - DS700 Final Project

hc.data = read.csv("Abbeville_Cleansed.csv", header = TRUE, sep = ";")
hc.data = hc.data[ ,-1]
attach(hc.data)
...
# Plot residuals in acf and pacf 
